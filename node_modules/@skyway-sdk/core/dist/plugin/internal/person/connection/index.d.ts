...
export declare class P2PConnection implements SkyWayConnection {
    ...
    /**@internal */
    constructor(_iceManager: IceManager, _signaling: SignalingSession, _context: SkyWayContext, channelId: string, localPerson: LocalPersonImpl, remoteMember: RemoteMember);
    /**
     * @internal
     * @throws {SkyWayError}
     */
