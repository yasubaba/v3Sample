...
class SkyWayChannelImpl {
    ...
    _setupListenChannelEvent() {
        ...
        this._channelImpl.onPublicationDisabled.add(({ publication }) => this._handleOnPublicationDisabled(publication));
    ...
    moveChannel(adapter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(adapter instanceof localPerson_1.LocalPersonAdapter)) {
                throw (0, util_1.createError)({
                    operationName: 'SkyWayChannelImpl.moveChannel',
                    path: log.prefix,
                    info: errors_1.errors.invalidArgumentValue,
                    channel: this,
                    context: this._context,
                });
            }
            ...
            if (this.id === leaveChannel.id) {
                throw (0, util_1.createError)({
                    operationName: 'SkyWayChannelImpl.moveChannel',
                    path: log.prefix,
                    info: errors_1.errors.cantMoveSameIdChannel,
                    channel: this,
                    context: this._context,
                });
            }
