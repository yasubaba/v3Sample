...
import { IceManager, SkyWayContext } from '@skyway-sdk/core';
...
export declare class TransportRepository {
    ...
    createTransport(personId: string, bot: SfuBotMember, transportOptions: TransportOptions, direction: 'send' | 'recv', iceManager: IceManager): SfuTransport;
