...
import { IceManager, SkyWayContext, TransportConnectionState } from '@skyway-sdk/core';
...
export declare class SfuTransport {
    ...
    constructor(msTransport: Transport, _bot: SfuBotMember, _iceManager: IceManager, _sfuApi: SfuRestApiClient, _context: SkyWayContext);
    toJSON(): {
        id: string;
        direction: "send" | "recv";
